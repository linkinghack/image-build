...
docker buildx build --platform linux/arm64,linux/amd64 -t linkinghack/ubuntu:jammy-fat -f ./dockerfiles/base-img/ubuntu.Dockerfile ./dockerfiles/base-img/ --push;
